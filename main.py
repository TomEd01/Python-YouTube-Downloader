...
def cargando(stream, chunk, bytes_remaining):
    ...
    print('\n'+Fore.RED + proceso)
#print(video.streams.get_highest_resolution())#Maxima resolucion
#print(video.streams.get_lowest_resolution())#Media resolución
#print(video.streams.get_audio_only())#Tipo audio               https://www.youtube.com/watch?v=C9qxnGlS3PQ
...
while True: #Empezamos a iniciar un menu interactivo
    ...
    while True: #Empezamos el segundo menu interactivo
        ...
        if posible_error=='a':
            ...
            video.streams.get_audio_only().download(ubicacion)#Obción de audio mp3
